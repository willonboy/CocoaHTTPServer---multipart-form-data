...
- (NSString *)filePathForURI:(NSString *)path
{
    ...
    NSLog(@"NOW path is :%@", relativePath);
...
- (NSObject<HTTPResponse> *)httpResponseForMethod:(NSString *)method URI:(NSString *)path
{
	...
	NSLog(@"httpResponseForMethod path:%@ \n", path);
...
{
    NSLog(@"dataprint:%@",[[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding]);
